...
$cfg['url']	= 'http://tenders.livomedia.ru/upload';
$cfg['root']	= "/var/www/minister/data/www/tenders.livomedia.ru" . DIR_SEP . "upload";			// http://www.yousite.com/upload/		absolute path
